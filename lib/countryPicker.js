    ...
    return (
      ...
      >
        <View style={styles.basicContainer}>
          ...
          >
            <View style={[styles.buttonView, this.props.buttonsContainerStyle]}>
              <TouchableOpacity onPress={this.onPressCancel}>
                <Text style={[{ color: buttonColor }, this.props.buttonTextStyle, this.props.cancelTextStyle]}>
                  {this.props.cancelText || 'Cancel'}
                </Text>
              </TouchableOpacity>

              <TouchableOpacity onPress={this.onPressSubmit}>
                <Text style={[{ color: buttonColor }, this.props.buttonTextStyle, this.props.confirmTextStyle]}>
            ...
            <View style={styles.mainBox}>
              <Picker
                ...
                mode="dialog"
              >
                {Country.getAll(this.props.orderBy).map((country, index) => this.renderItem(country, index))}
              </Picker>
            </View>
          </View>
        </View>
